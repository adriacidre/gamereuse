...
{{-- Web site Title --}}
@section('title')
Terms and conditions :: Game Reuse
@stop


{{-- Content --}}
@section('content')
@include('site/shared/header', [ 'headerTitle' => 'Terms of service' ])

<section id="content">
    <section id="terms" class="mt15">
        <div class="container">
            <p>These terms of service ("Terms") apply to your access and use of <strong>GameReuse.com</strong> (the "Service"). Please read them carefully.</p>

            <h2>
                <a id="user-content-accepting-these-terms" class="anchor" href="#accepting-these-terms" aria-hidden="true"><span class="octicon octicon-link"></span></a>Accepting these Terms</h2>

            <p>If you access or use the Service, it means you agree to be bound by all of the terms below. So, before you use the Service, please read all of the terms. If you don't agree to all of the terms below, please do not use the Service. Also, if a term does not make sense to you, please let us know by e-mailing <strong>gamereuse@oridoki.com</strong>.</p>

            <h2>
                <a id="user-content-changes-to-these-terms" class="anchor" href="#changes-to-these-terms" aria-hidden="true"><span class="octicon octicon-link"></span></a>Changes to these Terms</h2>
            ...
            <p>Whenever we make changes to these Terms, the changes are effective <strong>10 days</strong> after we post such revised Terms (indicated by revising the date at the top of these Terms) or upon your acceptance if we provide a mechanism for your immediate acceptance of the revised Terms (such as a click-through confirmation or acceptance button). It is your responsibility to check <strong>gamereuse.com</strong> for changes to these Terms.</p>
            ...
            <h2>
                <a id="user-content-privacy-policy" class="anchor" href="#privacy-policy" aria-hidden="true"><span class="octicon octicon-link"></span></a>Privacy Policy</h2>

            <p>For information about how we collect and use information about users of the Service, please check out our privacy policy available at <strong><a href="/policy">Privacu Policy</a></a></strong>.</p>

            <h2>
                <a id="user-content-third-party-services" class="anchor" href="#third-party-services" aria-hidden="true"><span class="octicon octicon-link"></span></a>Third-Party Services</h2>
            ...
            <h2>
                <a id="user-content-creating-accounts" class="anchor" href="#creating-accounts" aria-hidden="true"><span class="octicon octicon-link"></span></a>Creating Accounts</h2>
            ...
            <h2>
                <a id="user-content-your-content--conduct" class="anchor" href="#your-content--conduct" aria-hidden="true"><span class="octicon octicon-link"></span></a>Your Content &amp; Conduct</h2>
            ...
            <h2>
                <a id="user-content-developer-name-materials" class="anchor" href="#developer-name-materials" aria-hidden="true"><span class="octicon octicon-link"></span></a>
                <strong>GameReuse</strong> Materials</h2>
            ...
            <h2>
                <a id="user-content-hyperlinks-and-third-party-content" class="anchor" href="#hyperlinks-and-third-party-content" aria-hidden="true"><span class="octicon octicon-link"></span></a>Hyperlinks and Third Party Content</h2>
            ...
            <p><strong>GameReuse</strong> makes no claim or representation regarding, and accepts no responsibility for third party websites accessible by hyperlink from the Service or websites linking to the Service. When you leave the Service, you should be aware that these Terms and our policies no longer govern.</p>
            ...
            <h2>
                <a id="user-content-unavoidable-legal-stuff" class="anchor" href="#unavoidable-legal-stuff" aria-hidden="true"><span class="octicon octicon-link"></span></a>Unavoidable Legal Stuff</h2>
            ...
            <h2>
                <a id="user-content-copyright-complaints" class="anchor" href="#copyright-complaints" aria-hidden="true"><span class="octicon octicon-link"></span></a>Copyright Complaints</h2>

            <p>We take intellectual property rights seriously. In accordance with the Digital Millennium Copyright Act ("DMCA") and other applicable law, we have adopted a policy of terminating, in appropriate circumstances and, at our sole discretion, access to the service for users who are deemed to be repeat infringers. <strong><a href="/copyright">Copyright policy</a></strong></p>

            <h2>
                <a id="user-content-termination" class="anchor" href="#termination" aria-hidden="true"><span class="octicon octicon-link"></span></a>Termination</h2>

            <p>If you breach any of these Terms, we have the right to suspend or disable your access to or use of the Service.</p>

            <h2>
                <a id="user-content-entire-agreement" class="anchor" href="#entire-agreement" aria-hidden="true"><span class="octicon octicon-link"></span></a>Entire Agreement</h2>

            <p>These Terms constitute the entire agreement between you and <strong>GameReuse</strong> regarding the use of the Service, superseding any prior agreements between you and <strong>GameReuse</strong> relating to your use of the Service.</p>
            ...
            <p>Please let us know what you think of the Service, these Terms and, in general, <strong>gamereuse.com</strong>. When you provide us with any feedback, comments or suggestions about the Service, these Terms and, in general, <strong>gamereuse.com</strong>, you irrevocably assign to us all of your right, title and interest in and to your feedback, comments and suggestions.</p>

            <h2>
                <a id="user-content-questions--contact-information" class="anchor" href="#questions--contact-information" aria-hidden="true"><span class="octicon octicon-link"></span></a>Questions &amp; Contact Information</h2>

            <p>Questions or comments about the Service may be directed to us at the email address <strong>gamereuse@oridoki.com</strong>.</p>

            <p>Last Revised: <strong>29/12/2014</strong></p>
            <br /><br /><br />
        </div>
    </section>
</section>
