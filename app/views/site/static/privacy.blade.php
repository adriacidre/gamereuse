...
{{-- Web site Title --}}
@section('title')
Privacy policy :: Game Reuse
@stop


{{-- Content --}}
@section('content')
@include('site/shared/header', [ 'headerTitle' => 'Privacy policy' ])
...
<section id="content">
    <section id="terms" class="mt15">
        <div class="container">
            ...
            <h2>
                <a id="user-content-collection-of-information" class="anchor" href="#collection-of-information" aria-hidden="true"><span class="octicon octicon-link"></span></a>Collection of Information</h2>

            <h3>
                <a id="user-content-information-you-provide-to-us" class="anchor" href="#information-you-provide-to-us" aria-hidden="true"><span class="octicon octicon-link"></span></a>Information You Provide to Us</h3>
            ...
            <h3>
                <a id="user-content-information-we-collect-automatically-when-you-use-the-services" class="anchor" href="#information-we-collect-automatically-when-you-use-the-services" aria-hidden="true"><span class="octicon octicon-link"></span></a>Information We Collect Automatically When You Use the Services</h3>

            <p>When you access or use our services, we automatically collect information about you, including:</p>

            <ul class="task-list">
                <li>
                    <strong>Log Information</strong>: We log information about your use of our services, including the type of browser you use, access times, pages viewed, your IP address and the page you visited before navigating to our services.</li>
                <li>
                    <strong>Device Information</strong>: We collect information about the computer you use to access our services, including the hardware model, and operating system and version.</li>
                <li>
                    <strong>Location Information</strong>: We may collect information about the location of your device each time you access or use one of our mobile applications or otherwise consent to the collection of this information.</li>
                <li>
            ...
            <h3>
                <a id="user-content-information-we-collect-from-other-sources" class="anchor" href="#information-we-collect-from-other-sources" aria-hidden="true"><span class="octicon octicon-link"></span></a>Information We Collect From Other Sources</h3>
            ...
            <h2>
                <a id="user-content-use-of-information" class="anchor" href="#use-of-information" aria-hidden="true"><span class="octicon octicon-link"></span></a>Use of Information</h2>
            ...
            <h2>
                <a id="user-content-sharing-of-information" class="anchor" href="#sharing-of-information" aria-hidden="true"><span class="octicon octicon-link"></span></a>Sharing of Information</h2>
            ...
            <ul class="task-list">
                ...
                <li>In connection with any merger, sale of <strong>GameReuse</strong> assets, financing or acquisition of all or a portion of our business to another company; and</li>
            ...
            <h2>
                <a id="user-content-third-party-analytics" class="anchor" href="#third-party-analytics" aria-hidden="true"><span class="octicon octicon-link"></span></a>Third Party Analytics</h2>
            ...
            <h2>
                <a id="user-content-your-information-choices" class="anchor" href="#your-information-choices" aria-hidden="true"><span class="octicon octicon-link"></span></a>Your Information Choices</h2>
            ...
            <h3>
                <a id="user-content-promotional-communications" class="anchor" href="#promotional-communications" aria-hidden="true"><span class="octicon octicon-link"></span></a>Promotional Communications</h3>
            ...
            <h2>
                <a id="user-content-contact-us" class="anchor" href="#contact-us" aria-hidden="true"><span class="octicon octicon-link"></span></a>Contact Us</h2>

            <p>If you have any questions about this privacy policy, please contact us at:  <strong>gamereuse@oridoki.com</strong>.</p>
